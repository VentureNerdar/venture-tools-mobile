const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./CXXj7cGJ.js","./BcM8nbUc.js","./entry.UizA9sMz.css"])))=>i.map(i=>d[i]);
import{T as ee,x as me,m as T,v as be,aW as _e}from"./BcM8nbUc.js";const ye=()=>{};var V={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g=new Ve("@firebase/app"),rt="@firebase/app-compat",at="@firebase/analytics-compat",st="@firebase/analytics",it="@firebase/app-check-compat",ot="@firebase/app-check",ct="@firebase/auth",lt="@firebase/auth-compat",ht="@firebase/database",dt="@firebase/data-connect",ft="@firebase/database-compat",ut="@firebase/functions",pt="@firebase/functions-compat",gt="@firebase/installations",mt="@firebase/installations-compat",bt="@firebase/messaging",_t="@firebase/messaging-compat",yt="@firebase/performance",Et="@firebase/performance-compat",It="@firebase/remote-config",vt="@firebase/remote-config-compat",Dt="@firebase/storage",St="@firebase/storage-compat",wt="@firebase/firestore",Ct="@firebase/vertexai",At="@firebase/firestore-compat",Bt="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F="[DEFAULT]",Tt={[H]:"fire-core",[rt]:"fire-core-compat",[st]:"fire-analytics",[at]:"fire-analytics-compat",[ot]:"fire-app-check",[it]:"fire-app-check-compat",[ct]:"fire-auth",[lt]:"fire-auth-compat",[ht]:"fire-rtdb",[dt]:"fire-data-connect",[ft]:"fire-rtdb-compat",[ut]:"fire-fn",[pt]:"fire-fn-compat",[gt]:"fire-iid",[mt]:"fire-iid-compat",[bt]:"fire-fcm",[_t]:"fire-fcm-compat",[yt]:"fire-perf",[Et]:"fire-perf-compat",[It]:"fire-rc",[vt]:"fire-rc-compat",[Dt]:"fire-gcs",[St]:"fire-gcs-compat",[wt]:"fire-fst",[At]:"fire-fst-compat",[Ct]:"fire-vertex","fire-js":"fire-js",[Bt]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */C(Vt,zt,"app");const m=ee();var Q;if(!((Q=m.public)!=null&&Q.firebase))throw console.error("Firebase configuration is missing"),new Error("Firebase configuration is missing");const Wt={apiKey:m.public.firebase.apiKey,authDomain:m.public.firebase.authDomain,projectId:m.public.firebase.projectId,storageBucket:m.public.firebase.storageBucket,messagingSenderId:m.public.firebase.messagingSenderId,appId:m.public.firebase.appId,measurementId:m.public.firebase.measurementId},Gt=ce(Wt),en=me("auth",()=>{const t=ee(),e=T(null),n=T(JSON.parse(localStorage.getItem("authUser")||"{}")),a=T(localStorage.getItem("Bearer")||"");async function r(){const l=localStorage.getItem("Bearer")||"",f={Accept:"application/json","Content-Type":"application/json"};l&&(f.Authorization=l);const d=await $fetch(t.public.apiURL+"auth/user",{method:"GET",credentials:"include",headers:f}).catch(u=>{console.log(u)});d&&(e.value=d,n.value=d,localStorage.setItem("authUser",JSON.stringify(d)))}async function s(l){try{const f=i();let d=null;try{const I=t.public.firebase.vapidKey,{getMessaging:de,getToken:fe,onMessage:ue}=await _e(async()=>{const{getMessaging:E,getToken:S,onMessage:w}=await import("./CXXj7cGJ.js");return{getMessaging:E,getToken:S,onMessage:w}},__vite__mapDeps([0,1,2]),import.meta.url),U=de(Gt);await Notification.requestPermission()==="granted"&&(d=await fe(U,{vapidKey:I}),d&&localStorage.setItem("notificationToken",d)),ue(U,E=>{var S,w;if(console.log("Message received in foreground:",E),(S=E.notification)!=null&&S.title&&((w=E.notification)!=null&&w.body)){const{title:pe,body:ge}=E.notification;new Notification(pe,{body:ge,icon:"/logo-vertical.png"})}})}catch(I){console.error("FCM error:",I)}localStorage.setItem("deviceId",f);const y={Accept:"application/json","Content-Type":"application/json",Authorization:localStorage.getItem("Bearer")||""};await $fetch(`${t.public.apiURL}users/id/${l}/devices`,{method:"POST",body:{device_id:f,device_type:"web",device_name:navigator.userAgent,notification_token:d},headers:y})}catch(f){console.error("Error registering device:",f)}}function i(){return"mobile_"+crypto.randomUUID()}async function o(l){await $fetch(t.public.rootURL+"sanctum/csrf-cookie",{method:"GET",credentials:"include"});const f=await $fetch(t.public.apiURL+"login",{method:"POST",body:l,credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"}}).catch(d=>{console.log(d)});return f&&"token"in f&&(a.value="Bearer "+f.token,localStorage.setItem("Bearer",a.value),await s(f.user.id),await r()),f}async function c(){const l=localStorage.getItem("Bearer")||"",f=localStorage.getItem("deviceId")||"",d={Accept:"application/json","Content-Type":"application/json"};l&&(d.Authorization=l),await $fetch(t.public.apiURL+"auth/logout",{method:"POST",credentials:"include",body:{device_id:f},headers:d}).catch(u=>{console.log(u)}),e.value=null,localStorage.clear(),be("/")}return{user:e,login:o,fetchUser:r,logout:c,authUser:n}});export{A as C,se as E,D as F,x as _,Zt as a,Xt as b,Yt as c,qt as d,Qt as g,Oe as i,Ze as o,C as r,en as u,Me as v};
