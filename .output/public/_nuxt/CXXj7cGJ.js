import{r as m,_ as y,C as T,a as D,E as z,o as P,F as Ie,g as ke,b as M,v as ve,i as Se,c as Ae,d as S}from"./DnEc7Rgu.js";import"./BcM8nbUc.js";const X="@firebase/installations",R="0.6.14";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zt(e=ke()){return Yt().then(t=>{if(!t)throw d.create("unsupported-browser")},t=>{throw d.create("indexed-db-unsupported")}),D(M(e),"messaging").getImmediate()}async function en(e,t){return e=M(e),Te(e,t)}function tn(e,t){return e=M(e),zt(e,t)}Jt();export{Zt as getMessaging,en as getToken,Yt as isSupported,tn as onMessage};
